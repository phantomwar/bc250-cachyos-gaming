...
**Serve.** A mod **P3.00 CHIPSETMENU** é o padrão da comunidade e pode ser gravada **sobre qualquer base** (P2.00–P5.00): voltar à base P3.00 é intencional e seguro, e é o que destrava VRAM dinâmica + menus de chipset. **Não existem mods públicas para outras bases** — a `P5.00_clv` (base P5.00, "destrava tudo") circula **apenas no Discord, sem hash público**; se for usá-la, confirme o arquivo com pelo menos duas pessoas independentes. Para montar **sua própria firmware customizada**, use o **[Firmware Menu Script (Forbidden-Darkness)](https://github.com/Forbidden-Darkness/AMD-BC-250-UEFI-v2.2-Firmware-Menu-Script)** — backup + flash de firmware custom via menu interativo — combinado com módulos DXE da comunidade (ex.: **[BC250-DXE-SMU-Core-Unlock](https://github.com/RescueMei/BC250-DXE-SMU-Core-Unlock)**, **[bc250-efi-core-unlock](https://github.com/Hexxeh/bc250-efi-core-unlock)**), e valide o resultado no **[Discord](https://discord.gg/8eZfFWhczz)** antes de gravar. → *Guia, seção 3.1.*

### 13. O que é o "fix ACPI" e por que preciso dele?
...
### 14. É seguro destravar os 8 núcleos? E as 40 CUs?
...
### 15. Brick na BIOS — como recupero?
...
### 16. Preciso trocar a pasta térmica / melhorar o cooler?
...
### 17. Que fonte eu preciso?

**250 W+ no trilho 12 V** para uso normal; mais folga (300 W+) se for fazer overclock ou destravar CUs. Jogos puxam 220–250 W; FurMark com OC já passou de 320 W. E **confira a polaridade do 8-pin antes de ligar** — invertido queima a placa. → *Guia, seção 2.*

### 18. Tem WiFi/Bluetooth?

**Não embutido.** Use adaptadores USB (funcionam normalmente no Linux) ou um dongle barato.

### 19. Como funciona o áudio?
...
### 20. Quais versões de kernel devo usar (ou evitar)?
...
### 22. Como faço overclock sem "bronzeá" a placa?
...
### 24. Onde tiro dúvidas complexas?
